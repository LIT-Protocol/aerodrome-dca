...
- A Vincent App with the Aerodrome swap ability
...
- Backend (Node.js):
  ...
  - Integration with a Vincent App to execute swaps on behalf of users
    - Vincent Aerodrome Swap ability: authorizes Aerodrome to spend user tokens and executes the actual token swaps
...
3. Add the Aerodrome Swap ability.
4. Publish the app.
